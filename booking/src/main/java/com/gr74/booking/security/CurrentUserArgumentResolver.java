...
/**
 * Resolves {@link CurrentUser}-annotated {@code String} parameters to the JWT {@code sub}.
 * The {@code X-User-Id} header is never read; requests without a token are rejected with 401.
 */
public class CurrentUserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        // Strictly the JWT `sub` — no fallback. Anything else is a misconfiguration, so fail with 401.
