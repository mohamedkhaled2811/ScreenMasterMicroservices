 ...
 * 403 on every refund call while payment creation keeps working — the single most common Keycloak +
 * Spring misconfiguration, and the reason this converter gets its own unit test
